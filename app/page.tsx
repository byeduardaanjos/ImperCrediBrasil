...
export default function Home(){
 ...
 async function submit(e:React.FormEvent<HTMLFormElement>){
  ...
  setSending(true);
  const lead={full_name:fullName,whatsapp,email,cpf,postal_code:postalCode,address,address_number:address,address_number:addressNumber,neighborhood,complement:complement||null,city,state,desired_amount:desiredAmount,monthly_income:monthlyIncome,consent_at:new Date().toISOString(),source:"site"};
  try{
